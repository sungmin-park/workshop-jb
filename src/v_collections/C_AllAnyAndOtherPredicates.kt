...
fun Shop.checkAllCustomersAreFrom(city: City): Boolean = countCustomersFrom(city) == customers.size()

fun Shop.hasCustomerFrom(city: City): Boolean = countCustomersFrom(city) > 0
